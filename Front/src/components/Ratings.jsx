    ...
    return (
        <section className=" px-4 xl:px-0 pt-[80px] pb-[232px] xl:pb-[54px] mb-[184px] bg-[#F5F5F5] xl:text-center">
            <div className=" max-w-screen-lg mx-auto">
                ...
                <p className=" mt-8 text-lg leading-[32px] tracking-[0.09px] xl:mx-8">
            ...
            <div className=" relative max-w-screen-lg mx-auto">
                <img
                    className="hidden xl:block absolute right-[100px] bottom-[40px] z-10"
                    src="/ArrowNoah.svg"
                    alt="ArrowNoah"
                />
                <img
                    className="absolute left-1/2 transform -translate-x-1/2 bottom-50 xl:-bottom-[150px] lg:left-auto lg:right-0 xl:-translate-x-[10px]"
