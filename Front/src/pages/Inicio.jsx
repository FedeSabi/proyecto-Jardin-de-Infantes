  ...
  return (
    <section className="flex bg-yellow-200 p-4 ">
      <div className="flex-1">
        <h1 className="text-left font-bold text-6xl py-16 px-20 mt-16">
          Educación Temprana, cuidado y aprendizaje en un ambiente de alegría
        </h1>
        <h2 className="text-left text-xl font-bold justify-center py-0 px-20 mt-1">
        ...
        <div className="m-10 p-5">
          <button className="bg-black rounded-3xl w-80 h-20 p-8 m-3 text-white ">
            Solicitar ahora
          </button>
        </div>
      </div>
      <div className="flex-1">
        <img src={nenaSaltando} alt="nena" className="w-[500px] pt-28 py-3 px-3 m-auto" />
      </div>
    </section>
  );
};
